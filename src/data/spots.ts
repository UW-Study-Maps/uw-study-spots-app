 ...
 * data.js. They have no design-authored crowding seed, so — rather than
 * inventing fake reports — they start at `status: "none"`, the same
 * "nobody's reported yet" state Babcock Dairy Store uses below.
 *
